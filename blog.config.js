...
const BLOG = {
  ...
  IMAGE_COMPRESS_WIDTH: process.env.NEXT_PUBLIC_IMAGE_COMPRESS_WIDTH || 200, // 图片压缩宽度默认值，作用于博客封面和文章内容 越小加载图片越快
  ...
  WIDGET_PET_LINK:
    ...
    'https://raw.githubusercontent.com/imuncle/live2d/master/model/33/model.default.json', // 挂件模型地址 @see https://github.com/xiazeyu/live2d-widget-models
